...
public class RealizarCompraDTO {
    ...
    public RealizarCompraDTO(ArrayList<RealizarCompraProducto> productos, ArrayList<RealizarCompraServicio> servicios,@DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime fechaDelServicio, String numeroTarjetaPago, Integer cvv, boolean pagarCuentaCliente) {
